...
const HeroSection = () => {
  const quickLinks = [
    "Caregivers", "Artificial Intelligence", "RCM", "Patients", "AMP", "Clinical",
  ];

  const exploreResources = [
    { name: "Caregiver Management", icon: Stethoscope },
    { name: "Patient Management", icon: UserPlus },
    { name: "Compliance", icon: ShieldCheck },
    { name: "Learning Resources", icon: Book },
    { name: "Tutorials", icon: MonitorPlay },
  ];
  ...
  return (
    ...
    <section className="relative flex h-182 w-full flex-col justify-center overflow-hidden">
      ...
      {/* Main Content  */}
      <div className="relative z-20 mx-auto flex w-full max-w-300 flex-col items-start gap-16 px-6 md:px-12">
